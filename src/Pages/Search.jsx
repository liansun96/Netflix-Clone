  ...
  return (
    <div className="bg-[#141414]">
      ...
      <div className="overflow-hidden">
        <div className="w-[95%] mx-auto pt-28 pb-20">
          <div className="flex flex-wrap justify-between relative pt-11 last:mr-auto">
            {data?.results?.map((result, index) => {
              ...
              return (
                <div
                  key={result?.id}
                  className="2xl:w-[230px] 3xl:w-[300px] 4xl:w-[390px] last:mr-auto last:ms-3"
                >
                    ...
                    <div className="group/item flex flex-col mb-20 3xl:mb-24 4xl:mb-28">
                      {result?.backdrop_path == null ? (
                        <img
                          ...
                          className="rounded object-cover object-top h-[124px] w-[230px] 3xl:w-[290px] 4xl:w-[390px] cursor-pointer group/edit group-hover/item:rounded-none group-hover/item:delay-300 group-hover/item:duration-300"
                          alt=""
                        />
                      ) : (
                        <img
                          ...
                          className="w-[230px] 3xl:w-[290px] 4xl:w-[390px] rounded cursor-pointer group/edit group-hover/item:rounded-none group-hover/item:delay-300 group-hover/item:duration-500"
                          alt=""
                        />
                      )}
                      <div className="relativ w-[230px] 3xl:w-[290px] 4xl:w-[390px] group/edit invisible group-hover/item:visible group-hover/item:delay-500 group-hover/item:duration-500 group-hover/item:h-full group-hover/item:p-3 bg-gray-800 h-[0px]">
