                        ...
                        <div className="hidden lg:block">
                          {result?.backdrop_path == null ? (
                            <img
                              ...
                              className="rounded object-cover object-top h-[124px] xl:w-[210px] 2xl:w-[230px] 3xl:w-[290px] 4xl:w-[390px] rounded cursor-pointer group/edit group-hover/item:rounded-b-none group-hover/item:delay-300 group-hover/item:duration-300"
                              alt=""
                            />
                          ) : (
                            <img
